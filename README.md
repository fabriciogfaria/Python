...
4. **Análise preditiva**
   1. Um código desenvolvido utilizando o `yfinance`  para acessar dados de ações de empresas, `Prophet` para treinar meu código e o `plot_plotly` para gerar um gráfico da predição.
